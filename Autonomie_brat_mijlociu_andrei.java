...
@Config
@Disabled
@Autonomous (name="autonomie_rosu_brat_mijlociu_andrei", group = "#*")
public class Autonomie_brat_mijlociu_andrei extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence stalpMij = drive.trajectorySequenceBuilder(new Pose2d())
                ...
                .strafeRight(13)
                .forward(6)
                .addDisplacementMarker(()->dropCone())
                .build();
    ...
    public void Con()
    {
        telemetry.addLine("Luare con stack");
        telemetry.update();
        robot.scripS.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        while (robot.scripS.getCurrentPosition()!=710) {
            robot.scripS.setTargetPosition(710);
        }
        robot.scripS.setPower(1);
    }
    ...
    void LowerUntilCon()
    {
        while(robot.isPressedHall()==false)
        {
            robot.scripS.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
            robot.scripS.setPower(-1);
        }
        robot.scripS.setPower(0);
        pickCone();
    }
