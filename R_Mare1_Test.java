...
@Autonomous (name="R_Mare1_Test", group = "#*")
@Disabled
public class R_Mare1_Test extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence stalpMij2 = drive.trajectorySequenceBuilder(new Pose2d(-70,-11,Math.toRadians(180)))
    ...
    public void Level(){
        ...
        telemetry.update();
        robot.scripS.setTargetPosition(4000);
    ...
    public void StackLevel(){
        robot.scripS.setTargetPosition(2000);
        robot.scripS.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        robot.scripS.setPower(1);
    }
    ...
    public void Telementry(){
        telemetry.addData("Pos:",robot.scripS.getCurrentPosition());
        telemetry.update();
    }
